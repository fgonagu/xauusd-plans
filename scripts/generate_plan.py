...
def analyze_with_gemini_with_retry(market_data, max_retries=5, retry_delay=60):
    ...
    for attempt in range(1, max_retries + 1):
        try:
            ...
            REGLAS PARA ÓRDENES:
            • Mínimo 0 órdenes, máximo 6 órdenes
            ...
            {{
                ...
                "analysis_summary": "Resumen ejecutivo en 1 línea",
            ...
            - RESPUESTE SOLO CON JSON, sin texto adicional
            """
            ...
            if "503" in error_msg or "UNAVAILABLE" in error_msg or "429" in error_msg:
                print(f"⚠️ Gemini saturado (intento {attempt}/{max_retries})")
